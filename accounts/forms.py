...
class EmployeeRegistrationForm(UserCreationForm):
    ...
    detail_user = forms.CharField(required=True)
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["detail_user"].label = "Qui êtes vous ?"
        ...
        self.fields["detail_user"].widget.attrs.update({"placeholder": "parlez nous en queslques ligne de vous et de vos compétances"})
        self.fields["password1"].widget.attrs.update({"placeholder": "Enter Password"})
        self.fields["password2"].widget.attrs.update({"placeholder": "Confirm Password"})

    class Meta:
        model = User
        fields = ["first_name", "last_name", "email", "password1", "password2", "gender","detail_user"]
        error_messages = {
            ...
            "detail_user": {"required": "detail about u is required"},
        }
